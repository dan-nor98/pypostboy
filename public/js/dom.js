export function getDomElements() {
    return {
        ...
        responseBodyViewer: document.getElementById('responseBodyViewer'),
        responseBody: document.getElementById('responseBody'),
        responseBodyCode: document.getElementById('responseBodyCode'),
        responseBodyLineNumbers: document.getElementById('responseBodyLineNumbers'),
        ...
        snapshotNameModal: document.getElementById('snapshotNameModal'),
        snapshotNameModalClose: document.getElementById('snapshotNameModalClose'),
        snapshotNameModalTitle: document.getElementById('snapshotNameModalTitle'),
        snapshotNameInput: document.getElementById('snapshotNameInput'),
        snapshotNameCancelBtn: document.getElementById('snapshotNameCancelBtn'),
        snapshotNameSaveBtn: document.getElementById('snapshotNameSaveBtn'),
        envVarsModal: document.getElementById('envVarsModal'),
        envVarsModalClose: document.getElementById('envVarsModalClose'),
        openEnvVarsModalBtn: document.getElementById('openEnvVarsModalBtn'),
        ...
        appAuthStatus: document.getElementById('appAuthStatus'),
        authUsername: document.getElementById('authUsername'),
        authPassword: document.getElementById('authPassword'),
        loginBtn: document.getElementById('loginBtn'),
        registerBtn: document.getElementById('registerBtn'),
        registerSuccessModal: document.getElementById('registerSuccessModal'),
        registerRecoveryKey: document.getElementById('registerRecoveryKey'),
        copyRecoveryKeyBtn: document.getElementById('copyRecoveryKeyBtn'),
        registerRecoveryAcknowledge: document.getElementById('registerRecoveryAcknowledge'),
        registerRecoveryCloseBtn: document.getElementById('registerRecoveryCloseBtn'),
